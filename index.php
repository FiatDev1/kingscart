...
<div class="wrapper">
    <div id="carousel-slider" class="carousel slide carousel-fade" data-ride="carousel" data-pause="hover" data-interval="2500">
        ...
        <ol class="carousel-indicators">
            ...
            foreach ($result as $row) {
            ?>
                <li data-target="#carousel-slider" data-slide-to="<?php echo $i; ?>" <?php if ($i == 0) {
                                                                                            echo 'class="active"';
                                                                                        } ?>></li>
            <?php
                $i++;
        ...
        <div class="carousel-inner" role="listbox">
            ...
            ?>
                <div class="carousel-item <?php if ($i == 0) {
                                                echo 'active';
                                            } ?>" style="background-image:url(assets/uploads/<?php echo $row['photo'];  ?>); height:500px; background-position: top center; padding:150px 0px; background-size:cover;">
                    <div class="container">
                        <div class="row">
                            <div class="slide-text <?php if ($row['position'] == 'Left') {
                                ...
                                <a href="<?php echo $row['button_url']; ?>" target="_blank" class="btn btn-danger" data-animation="animated <?php if ($row['position'] == 'Left') {
                                                                                                                                                    echo 'fadeInLeft';
                                                                                                                                                } elseif ($row['position'] == 'Center') {
                                                                                                                                                    echo 'fadeInDown';
                                                                                                                                                } elseif ($row['position'] == 'Right') {
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="product-carousel">
                        ...
                        foreach ($result as $row) {
                        ?>
                            <div class="item" style="border-radius: 10px !important;">
                                <div class="thumb">
