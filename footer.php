		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-lg-3">
					<h3>About Us</h3>
					<p>We aim to offer our customers a variety of the latest products. We've come a long way, so we know exactly which direction to take when supplying you with high quality yet budget-friendly products. We offer all of this while providing excellent customer service and friendly support.</p>
				</div>
				<div class="col-md-6 col-lg-3">
					<h3>Contact Details</h3>
					<ul class="nav flex-column">
						<li class="nav-item"><i class="fa fa-globe"></i>&nbsp;&nbsp;<?php echo nl2br($contact_address); ?></li><br />
						<li class="nav-item"><i class="fa fa-phone"></i>&nbsp;&nbsp;<?php echo $contact_phone; ?></li><br />
						<li class="nav-item"><i class="fa fa-envelope">&nbsp;&nbsp;</i><a href="mailto:<?php echo $contact_email; ?>"><?php echo $contact_email; ?></a></li>
					</ul>
				</div>
				<div class="col-md-6 col-lg-3">
					<h3>Categories</h3>
				...
				<div class="col-md-6 col-lg-3">
					...
					<ul class="nav flex-column">
						<li class="nav-item"><a class="nav-link active" href="">Returns</a></li>
