...
?>
        <script>
            Swal.fire({
                ...
                // type: 'success',
                // title: 'Opps....',
                text: 'Sorry! There are only 0 of this item(s) in stock',
                icon: 'info',
        ...
        if (isset($_SESSION['cart_p_id'])) {
            ...
            if ($added == 1) {
                ...
                <script>
                    Swal.fire({
                        text: 'This product is already added to the shopping cart.',
                        icon: 'info',
                        showConfirmButton: false,
                        timer: 2000
                    });
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item"><a class="nav-link active" href="#description" aria-controls="description" role="tab" data-toggle="pill" aria-selected="true"><?php echo LANG_VALUE_59; ?></a></li>
                                <li class="nav-item"><a class="nav-link" href="#feature" aria-controls="feature" role="tab" data-toggle="pill" aria-selected="false"><?php echo LANG_VALUE_60; ?></a></li>
                                <li class="nav-item"><a class="nav-link" href="#condition" aria-controls="condition" role="tab" data-toggle="pill" aria-selected="false"><?php echo LANG_VALUE_61; ?></a></li>
                                <li class="nav-item"><a class="nav-link" href="#return_policy" aria-controls="return_policy" role="tab" data-toggle="pill"><?php echo LANG_VALUE_62; ?></a></li>
                                <li class="nav-item"><a class="nav-link" href="#review" aria-controls="review" role="tab" data-toggle="pill" aria-selected="false"><?php echo LANG_VALUE_63; ?></a></li>
                            </ul>
                        </div>
