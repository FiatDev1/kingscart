            ...
            <div class="card card-primary card-outline card-outline-tabs">
                <div class="card-header p-0 border-bottom-0">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item"><a class="nav-link active" href="#tab_1" data-toggle="pill" role="tab">About Us</a></li>
                        <li class="nav-item"><a class="nav-link" href="#tab_2" data-toggle="pill" role="tab">FAQ</a></li>
                        <li class="nav-item"><a class="nav-link" href="#tab_4" data-toggle="pill" role="tab">Contact</a></li>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6" style="padding-top:6px;">
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="customFile" name="about_banner">
                                    ...
                                    <div class="box box-info">
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6" style="padding-top:6px;">
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="customFile" name="faq_banner">
                                                        <label class="custom-file-label" for="custom-file">Choose File</label>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="box box-info">
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6" style="padding-top:6px;">
                                                <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="customFile" name="contact_banner">
                                                        <label class="custom-file-label" for="custom-file">Choose File</label>
                                                    </div>
                                                </div>
                                            </div>
