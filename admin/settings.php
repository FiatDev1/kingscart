            ...
            <div class="card card-primary card-outline card-outline-tabs">
                <div class="card-header p-0 border-bottom-0">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item"><a class="nav-link active" href="#tab_1" data-toggle="pill" role="tab">Logo</a></li>
                        <li class="nav-item"><a class="nav-link" href="#tab_2" data-toggle="pill" role="tab">Favicon</a></li>
                        <li class="nav-item"><a class="nav-link" href="#tab_3" data-toggle="pill" role="tab">Footer & Contact</a></li>
                        <li class="nav-item"><a class="nav-link" href="#tab_4" data-toggle="pill" role="tab">Message Settings</a></li>
                        <li class="nav-item"><a class="nav-link" href="#tab_5" data-toggle="pill" role="tab">Products</a></li>
                        <li class="nav-item"><a class="nav-link" href="#tab_6" data-toggle="pill" role="tab">Home Settings</a></li>
                        <li class="nav-item"><a class="nav-link" href="#tab_7" data-toggle="pill" role="tab">Banner Settings</a></li>
                        <li class="nav-item"><a class="nav-link" href="#tab_9" data-toggle="pill" role="tab">Payment Settings</a></li>
                        <li class="nav-item"><a class="nav-link" href="#tab_10" data-toggle="pill" role="tab">Head & Body Scripts</a></li>
                        <li class="nav-item"><a class="nav-link" href="#tab_11" data-toggle="pill" role="tab">Ads</a></li>
                    </ul>
