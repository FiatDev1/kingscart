			...
			<div class="card card-primary card-outline card-outline-tabs">
				<div class="card-header p-0 border-bottom-0">
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item"><a class="nav-link active" href="#tab_1" data-toggle="pill" role="tab">Update Information</a></li>
						<li class="nav-item"><a class="nav-link" href="#tab_2" data-toggle="pill" role="tab">Update Photo</a></li>
						<li class="nav-item"><a class="nav-link" href="#tab_3" data-toggle="pill" role="tab">Update Password</a></li>
					</ul>
